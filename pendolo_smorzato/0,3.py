...
# grafico dei punti
tempo, tetaP = np.loadtxt("./0,3.csv", delimiter=",", unpack=True, skiprows=1)
teta = tetaP / 180 * np.pi
fig, ax = mp.subplots()
ax.set_xlabel("TEMPO (s)", fontsize=11)
ax.set_ylabel("TETA (rad)", fontsize=11)
ticklist = np.arange(0, 25, 5)
ticklabel = ["0", "5", "10", "15", "20"]
...
ax2.set_title("corrente = 0.3A", fontsize=16, pad=15)

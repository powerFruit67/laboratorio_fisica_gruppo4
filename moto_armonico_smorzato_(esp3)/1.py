...
parametri, covar = optimize.curve_fit(f, tempo, teta, (4, 3.43, 3.43, -2))
print(parametri)
fig2, ax2 = mp.subplots()
ax2.set_title("corrente = 1A", fontsize=16, pad=15)

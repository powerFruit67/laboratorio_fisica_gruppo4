...
# rappresento
x, y = np.loadtxt("./molla3.csv", delimiter=";", unpack=True, skiprows=1)
m = 0.0299
...
#####
parametri, covarianza = optimize.curve_fit(f, x, y, (0.01, 22, 0, 0))
...
x2 = np.arange(0, 1.433, 0.01)
ticklist = [0.250, 0.500, 0.75, 1, 1.25, 1.5]
ticklabel = ["0.250", "0.500", "0.750", "1.000", "1.250", "1.500"]
ticklisty = [-0.020, -0.015, -0.010, -0.005, 0]
ticklabely = ["-0.020", "-0.015", "-0.010", "-0.005", "0"]

fig, ax = mp.subplots()
ax.set_title("andamento su y molla 3", fontsize=16)
...
t, x1 = np.loadtxt("./molla3x.csv", delimiter=";", unpack=True, skiprows=1)
